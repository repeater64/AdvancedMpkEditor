...
object BlindNotPrecraftedBarrel {
    ...
    val barrel get() = BarrelItem("Blind - Not Precrafted", PracticeTypeOption.BLIND, GamemodeOption.SURVIVAL, DifficultyOption.EASY, fixedSlotsData, randomSlotsData, junkSettings, healthHungerSettings, fireResSettings, allRandomiserLinkLabels)
}