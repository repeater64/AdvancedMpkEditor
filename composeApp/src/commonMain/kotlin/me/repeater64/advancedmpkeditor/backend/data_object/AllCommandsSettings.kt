...
data class AllCommandsSettings(
    ...
    companion object : BookSerializable<AllCommandsSettings> {
        ...
        override fun serializeToPages(it: AllCommandsSettings): List<String> {
            return FixedSlotsData.serialize(it.fixedSlotsData) + RandomSlotsData.serialize(it.randomSlotsData) + JunkSettings.serialize(it.junkSettings) + HealthHungerSettings.serialize(it.healthHungerSettings)
        }
        ...
        override fun deserializeFromPages(pages: List<String>): AllCommandsSettings {
            ...
            val healthHungerSettings = BookSerializable.getObjectAndRemainingPages(pages3, HealthHungerSettings).first
            return AllCommandsSettings(fixedSlotsData, randomSlotsData, junkSettings, healthHungerSettings)
        }
