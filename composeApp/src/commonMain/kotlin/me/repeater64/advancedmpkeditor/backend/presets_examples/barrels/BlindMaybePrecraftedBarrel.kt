...
object BlindMaybePrecraftedBarrel {
    ...
    private val randomSlotsData get() = RandomSlotsData(
        listOf(
            RandomSlotOptionsSet(
                "Explosives Or Explosive Ingredients",
                WeightedOptionList(mutableListOf(
                    ...
                    itemList(rawItem("white_bed", 5), rawItem("crying_obsidian", 5), weight = 1, label="precrafted"),
                    itemList(rawItem("white_bed", 4), rawItem("respawn_anchor", 1), rawItem("glowstone", 1), rawItem("crying_obsidian", 3), weight = 1, label="precrafted"),
                    itemList(rawItem("white_bed", 3), rawItem("respawn_anchor", 2), rawItem("glowstone", 2), rawItem("crying_obsidian", 10), weight = 1, label="precrafted"),
                    itemList(rawItem("white_bed", 2), rawItem("respawn_anchor", 3), rawItem("glowstone", 3), rawItem("crying_obsidian", 2), weight = 1, label="precrafted"),

                    itemList(rawItem("white_bed", 6), rawItem("crying_obsidian", 11), weight = 3, label="precrafted"),
                    itemList(rawItem("white_bed", 5), rawItem("respawn_anchor", 1), rawItem("glowstone", 1), rawItem("crying_obsidian", 4), weight = 3, label="precrafted"),
                    itemList(rawItem("white_bed", 4), rawItem("respawn_anchor", 2), rawItem("glowstone", 2), rawItem("crying_obsidian", 15), weight = 3, label="precrafted"),
                    itemList(rawItem("white_bed", 3), rawItem("respawn_anchor", 3), rawItem("glowstone", 3), rawItem("crying_obsidian", 4), weight = 3, label="precrafted"),

                    itemList(rawItem("white_bed", 7), rawItem("crying_obsidian", 6), weight = 2, label="precrafted"),
                    itemList(rawItem("white_bed", 6), rawItem("respawn_anchor", 1), rawItem("glowstone", 1), rawItem("crying_obsidian", 7), weight = 2, label="precrafted"),
                    itemList(rawItem("white_bed", 5), rawItem("respawn_anchor", 2), rawItem("glowstone", 2), rawItem("crying_obsidian", 8), weight = 2, label="precrafted"),
                    itemList(rawItem("white_bed", 4), rawItem("respawn_anchor", 3), rawItem("glowstone", 3), rawItem("crying_obsidian", 9), weight = 2, label="precrafted"),

                    itemList(rawItem("white_bed", 8), rawItem("crying_obsidian", 17), weight = 1, label="precrafted"),
                    itemList(rawItem("white_bed", 7), rawItem("respawn_anchor", 1), rawItem("glowstone", 1), rawItem("crying_obsidian", 2), weight = 1, label="precrafted"),
                    itemList(rawItem("white_bed", 6), rawItem("respawn_anchor", 2), rawItem("glowstone", 2), rawItem("crying_obsidian", 4), weight = 1, label="precrafted"),
                    itemList(rawItem("white_bed", 5), rawItem("respawn_anchor", 3), rawItem("glowstone", 3), rawItem("crying_obsidian", 13), weight = 1, label="precrafted"),
                ))
            ),
            RandomSlotOptionsSet(
                "Bow",
                WeightedOptionList(mutableListOf(
                    itemList(rawItem("crossbow"), weight = 1, conditions = invCondition("precrafted")),
                    itemList(availableItem().option, weight = 3, conditions = invCondition("precrafted")),
                    itemList(rawItem("bow"), weight = 3, conditions = condition("precrafted")),
                    itemList(rawItem("crossbow"), weight = 2, conditions = condition("precrafted")),
                    itemList(availableItem().option, weight = 1, conditions = condition("precrafted")),
                ))
            ),
            RandomSlotOptionsSet(
                "Arrows",
            ...
            RandomSlotOptionsSet(
                "Planks",
                WeightedOptionList(mutableListOf(
                    itemList(rawItem("oak_planks", 35), weight = 1, conditions=invCondition("precrafted")),
                    itemList(rawItem("oak_planks", 31), weight = 1, conditions=invCondition("precrafted")),
                    itemList(rawItem("oak_planks", 25), weight = 1, conditions=invCondition("precrafted")),
                    itemList(rawItem("oak_planks", 27), weight = 1, conditions=invCondition("precrafted")),

                    itemList(rawItem("oak_planks", 1), weight = 1, conditions=condition("precrafted")),
                    itemList(rawItem("oak_planks", 3), weight = 1, conditions=condition("precrafted")),
                    itemList(rawItem("oak_planks", 5), weight = 1, conditions=condition("precrafted")),
                    itemList(rawItem("oak_planks", 7), weight = 1, conditions=condition("precrafted")),
                ))
            ),
            RandomSlotOptionsSet(
                "Sticks",
            ...
            RandomSlotOptionsSet(
                "Gold Picks / Leftover Gold",
                WeightedOptionList(mutableListOf(
                    itemList(availableItem().option, weight = 1),
                    itemList(rawItem("gold_ingot", 5), weight = 1, conditions=invCondition("precrafted")),
                    itemList(rawItem("gold_ingot", 8), weight = 1, conditions=invCondition("precrafted")),
                    itemList(rawItem("gold_ingot", 12), weight = 1, conditions=invCondition("precrafted")),
                    itemList(rawItem("golden_pickaxe", 1), weight = 1, conditions=condition("precrafted")),
                    itemList(rawItem("golden_pickaxe", 2), weight = 1, conditions=condition("precrafted")),
                    itemList(rawItem("golden_pickaxe", 3), weight = 1, conditions=condition("precrafted")),
                ))
            ),
            RandomSlotOptionsSet(
                "Fire Res",
            ...
            RandomSlotOptionsSet(
                "Potential Crafting Table",
                WeightedOptionList(mutableListOf(
                    itemList(rawItem("crafting_table"), conditions=invCondition("precrafted")),
                    itemList(availableItem().option, conditions=condition("precrafted")),
                ))
            ),
            RandomSlotOptionsSet(
    ...
    private val allRandomiserLinkLabels = hashSetOf("gcarrot", "flesh", "pork", "bread", "salmon", "precrafted")

    val barrel get() = BarrelItem("Blind - (50% Chance Precrafted)", PracticeTypeOption.BLIND, GamemodeOption.SURVIVAL, DifficultyOption.EASY, fixedSlotsData, randomSlotsData, junkSettings, healthHungerSettings, fireResSettings, allRandomiserLinkLabels)
}